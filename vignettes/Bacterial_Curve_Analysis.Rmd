...
```{r}
# Set work dir and load example data
base_dir = "/home/jacobo/Documents/Projects/Curves/neckaR"

# R functions
# list.files(file.path(base_dir, "R"), pattern = "*.R", full.names = TRUE) %>% 
#   walk(function(x) source(x))
devtools::load_all(path = "/home/jacobo/Documents/Projects/Curves/neckaR/")
```
...
```{r}
# List file locations
data_dir = file.path(base_dir, "inst/extdata/")
