...
replace_values = list(list(210, 10, "ML0102"),
											list(201, 7, "OKA5073"),
											list(209, 6, "ML0056"),
											list(701, 10, "ML0102"),
											list(403, 5, "ML0056"))
...
MIC_cutoff_df = MIC_readjusted_df %>% 
...
# Combined df
MIC_AUC_final_df = dplyr::left_join(MIC_max_OD_df, MIC_selected_AUC_df, 
																		by = dplyr::join_by("RRPPRCC", "Strain"))
